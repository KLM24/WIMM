function [xk_plus,Pk_plus, muk_plus] = WIMM_3(rho,Fu_1,Qu_L1,Fu_2,Qu_L2,Fu_3,Qu_L3,Hu,Ru, Pi_L,xk_plus,Pk_plus,muk_plus,zk)
r=3;
muk_mix=zeros(r,r);
...
A_aug_3 = [Fu_3; Hu * Fu_3];
B_aug_3 = [eye(4) zeros(4,2);Hu eye(2)];
mu_t_3 = A_aug_3 * xk_plus;
sigma_t_3 = A_aug_3 * Pk_plus * A_aug_3' + B_aug_3 * [Qu_L3 zeros(4,2);zeros(2,4) Ru] * B_aug_3';
...
[phi_star_3, Q_star_3] = F_W(mu_t_3, sigma_t_3, rho, 4);
G_t_3 = phi_star_3.G;
S_t_3 = Q_star_3.Sigma;
Pk_plus_3 = S_t_3(1:4, 1:4) - G_t_3 * S_t_3(5:end, 1:4);
xk_plus_3 = G_t_3*(zk - mu_t_3(5:end,1)) + mu_t_3(1:4,1);

Lambda_1 = mvnpdf(zk-mu_t_1(5:end,1),[0 0]',S_t_1(5:end,5:end));
Lambda_2 = mvnpdf(zk-mu_t_2(5:end,1),[0 0]',S_t_2(5:end,5:end));
Lambda_3 = mvnpdf(zk-mu_t_3(5:end,1),[0 0]',S_t_3(5:end,5:end));
