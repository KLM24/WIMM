...
parfor    rn=1:rN
    ...
    Quv_L1=0.1^2*eye(2,2); Quv_L2=2^2*eye(2,2); %The one with lower noise level with standard deviation 0.1 m/s^2 and the other one with 2 m/s^2
    Qu_L1=Au*Quv_L1*Au'; Qu_L2=Au*Quv_L2*Au';
    ...
    Pk_plus=100*eye(4,4);muk_plus=[1/2 1/2]';
    ...
    for   k=1:K
        [xk_plus,Pk_plus,xk_plus_1,Pk_plus_1,xk_plus_2,Pk_plus_2, muk_plus]...
            =IMM_L(Fu_1,Qu_L1,Fu_2,Qu_L2,Hu,Ru, Pi_L,xk_plus_1,Pk_plus_1,xk_plus_2,Pk_plus_2, muk_plus, zk(:,k+1));%IMM_L with two models
    ...
    for   k=1:K
        [xk_plus,Pk_plus,xk_plus_1,Pk_plus_1,xk_plus_2,Pk_plus_2, muk_plus]...
            =WIMM(rho,Fu_1,Qu_L1,Fu_2,Qu_L2,Hu,Ru, Pi_L,xk_plus,Pk_plus, muk_plus, zk(:,k+1));%IMM_L with two models
        xk_WIMM(:,k+1)=xk_plus;
